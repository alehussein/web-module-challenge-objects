...
console.log('task 1b:', createMenuItem('icecream', '4', 'lunch'));
console.log('task 1b:', createMenuItem('drinks', '3', 'lunch'));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
const array = addReview(reviews)
console.log("task 5:", array[array.length - 1]);
//console.log(reviews);
